      ...
      <div className="flex  justify-between flex-col lg:flex-row space-y-5 lg:space-y-0  pt-5 xl:h-screen bg-green-100 ">
        <Slide left>
          <div className="pt-32 flex flex-col justify-center text-center lg:text-left md:p-20">
            ...
            <div className="mt-5">
              <Button className="py-3 lg:py-5 px-20 mr-2 mb-2 text-lg font-medium text-black/60 focus:outline-none bg-green-400 border rounded-md  hover:bg-green-500 hover:text-white hover:border-hidden">
                Get started
              </Button>
            </div>
          </div>
